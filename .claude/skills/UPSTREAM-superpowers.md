...
| systematic-debugging | identical+ | Improved cross-references in `root-cause-tracing.md` (links to `find-polluter.sh`) and `condition-based-waiting.md` (links to example file) |
