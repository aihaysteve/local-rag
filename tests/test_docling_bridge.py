...
class TestMarkdownToDoclingDoc:
    def test_returns_docling_document(self) -> None:
        from ragling.document.docling_bridge import markdown_to_docling_doc
...
class TestEpubToDoclingDoc:
    def test_returns_docling_document(self) -> None:
        from ragling.document.docling_bridge import epub_to_docling_doc
...
class TestRssToDoclingDoc:
    def test_returns_docling_document(self) -> None:
        from ragling.document.docling_bridge import rss_to_docling_doc
